...
public class MainActivity extends AppCompatActivity {
    ...
    public  int dip2px(Context context, float dpValue)//用于适配
    {
    ...
    int black_knight1_x = square, black_knight1_y = 0;//黑棋骑士1的当前位置
    int black_knight2_x = 6 * square, black_knight2_y = 0;//黑棋骑士2的当前位置
    ...
    int white_bishop1_x = 2 * square, white_bishop1_y = 7 * square;//白棋主教1的当前位置
    int white_bishop2_x = 5 * square, white_bishop2_y = 7 * square;//白棋主教2的当前位置
    int white_knight1_x = square, white_knight1_y = 7 * square;//白棋骑士1的当前位置
    int white_knight2_x = 6 * square, white_knight2_y = 7 * square;//白棋骑士2的当前位置
    ...
    int initial_black_knight1_x = square, initial_black_knight1_y = 0;//黑棋骑士1的初始位置
    int initial_black_knight2_x = 6 * square, initial_black_knight2_y = 0;//黑棋骑士2的初始位置
    ...
    int initial_white_bishop1_x = 2 * square, initial_white_bishop1_y = 7 * square;//白棋主教1的初始位置
    int initial_white_bishop2_x = 5 * square, initial_white_bishop2_y = 7 * square;//白棋主教2的初始位置
    int initial_white_knight1_x = square, initial_white_knight1_y = 7 * square;//白棋骑士1的初始位置
    int initial_white_knight2_x = 6 * square, initial_white_knight2_y = 7 * square;//白棋骑士2的初始位置
            ...
            if (chessman[0] >= 'a' && chessman[0] <= 'z')//第一个字母是小写，说明是白方的棋子
            {
                switch (chessman[0])
                {
                    case 'k'://表示选择的是国王
                    {
                        ...
                        {
                            ObjectAnimator translationX = ObjectAnimator.ofFloat(white_king1, "translationX",white_king1_x-initial_white_king1_x, goal_x-initial_white_king1_x);
                            ObjectAnimator translationY = ObjectAnimator.ofFloat(white_king1, "translationY",white_king1_y-initial_white_king1_y, goal_x-initial_white_king1_y);
                            white_king1_x = goal_x;
                            white_king1_y = goal_y;
                            AnimatorSet animatorset = new AnimatorSet();//新建一个组合动画
